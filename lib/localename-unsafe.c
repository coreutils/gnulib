    ...
    switch (primary)
      ...
      case LANG_AZERI:
        switch (sub)
          ...
          case 0x1e: return NM("az","@latin");
          case SUBLANG_AZERI_LATIN: return NM("az_AZ","@latin");
      ...
      case LANG_TAMAZIGHT:
        ...
        switch (sub)
          ...
          case SUBLANG_TAMAZIGHT_ARABIC: return NM("ber_MA","@arabic");
          case 0x1f: return NM("ber","@latin");
          case SUBLANG_TAMAZIGHT_ALGERIA_LATIN: return NM("ber_DZ","@latin");
          }
        return N("ber");
      case LANG_TAMIL:
        switch (sub)
